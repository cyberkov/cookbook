  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved ingredient as @ingredient" do
        ...
        post :create, {:ingredient => { "amount" => "invalid value" }}, valid_session
        assigns(:ingredient).should be_a_new(Ingredient)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested ingredient" do
        ...
        Ingredient.any_instance.should_receive(:update_attributes).with({ "amount" => "1.5" })
        put :update, {:id => ingredient.to_param, :ingredient => { "amount" => "1.5" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the ingredient as @ingredient" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Ingredient.any_instance.stub(:save).and_return(false)
        put :update, {:id => ingredient.to_param, :ingredient => { "amount" => "invalid value" }}, valid_session
        assigns(:ingredient).should eq(ingredient)
      end
